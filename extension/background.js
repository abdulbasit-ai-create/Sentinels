      ...
      if (isBlacklisted) {
        ...
        sendResponse({
          ...
          result: {
            ...
            riskLevel: 'critical',
            explanation: 'This domain has been added to your personal blacklist, meaning you or someone you trust has flagged it as untrustworthy.',
            realWorldExample: 'This is like having a "DO NOT TRUST" sticky note on your desk about someone — you decided ahead of time they are not safe.',
            actions: ['Close this website immediately', 'Remove from blacklist if you trust this site'],
            redFlags: [{ icon: '🔴', title: 'Blacklisted Domain', explanation: `You previously blacklisted ${domain}. The extension automatically blocks it.`, severity: 'critical' }],
      ...
      if (isWhitelisted) {
        ...
        sendResponse({
          ...
          result: {
            ...
            riskLevel: 'low',
            explanation: 'This domain is on your personal whitelist — you have marked it as trusted.',
            realWorldExample: 'This is like having a frequent customer card at your favorite store — they know you, and you trust them.',
            actions: ['Safe to continue browsing', 'Remove from whitelist if you change your mind'],
            redFlags: [],
